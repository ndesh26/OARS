...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { dept: @instructor.dept, email: @instructor.email, name: @instructor.name, password_digest: @instructor.password_digest } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { dept: @instructor.dept, email: @instructor.email, name: @instructor.name, password_digest: @instructor.password_digest } }
